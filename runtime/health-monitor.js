/** OpenClaw Runtime — Health Monitor */
...
/**
 * Check memory usage via free -m (Linux) or vm_stat (macOS).
 * Alert if usage > MEMORY_THRESHOLD_PERCENT.
 */
async function checkMemory() {
  ...
  try {
    ...
    // On macOS, `free` doesn't exist — skip gracefully
    if (err.code === "ENOENT") {
...
/**
 * Check a remote site by issuing an HTTP(S) GET and verifying a 2xx/3xx response.
 ...
 * @returns {{ localTimer: NodeJS.Timeout, remoteTimer: NodeJS.Timeout|null }}
 */
