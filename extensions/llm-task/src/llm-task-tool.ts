...
import type { KlawtyPluginApi } from "../api.js";
...
export function createLlmTaskTool(api: KlawtyPluginApi) {
  return {
    name: "llm-task",
    label: "LLM Task",
    description:
      "Run a generic JSON-only LLM task and return schema-validated JSON. Designed for orchestration from Lobster workflows via klawty.invoke.",
