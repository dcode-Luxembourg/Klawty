...
function mergeZaloAccountConfig(cfg: KlawtyConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: KlawtyConfig): ResolvedZaloAccount[] {
