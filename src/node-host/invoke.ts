...
const execHostEnforced = process.env.KLAWTY_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.KLAWTY_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
