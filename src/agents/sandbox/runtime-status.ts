...
function resolveMainSessionKeyForSandbox(params: { cfg?: KlawtyConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: KlawtyConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`klawty sandbox explain --session ${runtime.sessionKey}`)}`,
  );
