...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: KlawtyConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: KlawtyConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: KlawtyConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: KlawtyConfig; accountId?: string | null }) => number | undefined;
