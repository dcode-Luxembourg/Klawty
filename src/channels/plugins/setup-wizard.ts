...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: KlawtyConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: KlawtyConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: KlawtyConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: KlawtyConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: KlawtyConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: KlawtyConfig) => KlawtyConfig;
