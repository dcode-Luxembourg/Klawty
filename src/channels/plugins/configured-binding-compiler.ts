...
const compiledRegistryCache = new WeakMap<KlawtyConfig, CachedCompiledConfiguredBindingRegistry>();
...
export function primeCompiledBindingRegistry(cfg: KlawtyConfig): CompiledConfiguredBindingRegistry {
