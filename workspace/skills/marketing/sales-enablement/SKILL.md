...
1. **product-marketing-context.md** — positioning, differentiators, objections, proof points
2. **Competitor data** — competitor positioning and weaknesses
3. **CRM data** — common objections from lost deals

### Decision Logic

- Create sales decks, one-pagers, and battle cards from product-marketing-context
- Update objection handling docs when new objections surface in CRM
- Generate ROI calculators from customer proof points

### Output Routing

- Save enablement materials to `workspace/content/sales/`
- Post new materials to channel with usage guidance
...
| ---------------- | ---------------------------------------------------- |
| CRM              | Build enablement from product-marketing-context only |
| Competitor tools | Use public competitor page analysis                  |
...
| --------------------------- | ----------------- | ------------------------------------ |
| Closer (enablement) → Plume | `content_brief`   | Need landing page or case study copy |
| Scout → Closer (enablement) | `competitor_data` | Updated competitor intelligence      |
