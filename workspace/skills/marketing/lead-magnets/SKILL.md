...
1. **product-marketing-context.md** — audience, pain points, buyer journey
2. **CONTENT_BASELINE.md** — existing content to repurpose as lead magnets
3. **SEO_BASELINE.md** — keyword opportunities for gated content

### Decision Logic

- Match lead magnet format to buyer stage (awareness → checklist, consideration → guide, decision → template)
- Prioritize by: audience demand x creation effort x email capture potential
- Repurpose existing high-performing content first

### Output Routing

- Save lead magnet specs to `workspace/reports/growth/lead-magnet-{name}.md`
- Post recommendations to channel
...
| ---------------- | ---------------------------------------------------------------- |
| Analytics        | Use product-marketing-context buyer journey for format decisions |
| Email platform   | Design lead magnets without gating mechanism — manual setup      |
...
| ---------------------------- | --------------------- | ---------------------------------- |
| Anchor (lead-magnet) → Plume | `lead_magnet_content` | Lead magnet needs copywriting      |
| Anchor (lead-magnet) → Forge | `lead_magnet_gate`    | Gating form needs CRO optimization |
