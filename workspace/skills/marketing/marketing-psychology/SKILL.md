...
If `product-marketing-context.md` exists in the workspace, read it before applying mental models. Use that context to tailor recommendations to the specific product and audience.
...
1. **product-marketing-context.md** — audience, objections, switching dynamics
2. **CRO_BASELINE.md** — conversion issues that psychology could address
3. **Agent reports** — patterns across content, ads, and conversion data

### Decision Logic

- Apply relevant mental models from 72-model library to current marketing challenges
- Recommend psychological principles for specific pages, emails, or campaigns
- Review agent output for psychological optimization opportunities

### Output Routing

- Include psychology insights in weekly strategy brief
- Send specific recommendations to agents with context
...
| ---------------- | -------------------------------------------------------- |
| All tools        | Pure advisory — apply mental models to available context |
...
| ---------------------------- | ------------------ | ---------------------------------------------- |
| Compass (psychology) → Plume | `psychology_brief` | Apply specific psychological principle to copy |
| Compass (psychology) → Forge | `psychology_brief` | Apply behavioral principle to page design      |
| Compass (psychology) → Pulse | `psychology_brief` | Apply persuasion principle to ad creative      |
