...
1. **product-marketing-context.md** — product type, pricing, audience
2. **MARKETING_STATE.md** — current referral metrics
3. **Retention data** — customer satisfaction and NPS

### Decision Logic

- Design referral program structure based on product type and pricing
- Monitor referral rates and optimize incentives
- Identify top referrers for VIP treatment

### Output Routing

- Save program design to `workspace/reports/growth/referral-program-{date}.md`
- Post referral metrics to channel weekly
...
| ---------------------------- | ---------------------------------------------- |
| Referral tracker (Rewardful) | Program design and strategy only — no tracking |
| Analytics                    | Use referral platform native reporting         |
...
| -------------------------- | ------------------------- | ------------------------------------------ |
| Anchor (referral) → Plume  | `referral_content_needed` | Referral program needs promotional content |
| Anchor (referral) → Closer | `top_referrers`           | VIP referrers for special treatment        |
